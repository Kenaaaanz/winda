...
class AnalyticsEvent(models.Model):
    ...
    # Related objects
    property = models.ForeignKey('properties.Property', on_delete=models.CASCADE, null=True, blank=True, related_name='analytics_events')
    unit = models.ForeignKey('properties.Unit', on_delete=models.CASCADE, null=True, blank=True, related_name='analytics_events')
